...
参照大多数的论文以及`sklearn`模块，实现了三种基本的机器学习模型分类心电，不过这里只是做了异常/正常心电的判断，尝试着用SVM分类5种情况，结果正确率惨不忍睹

这里用机器学习处理心电得到的几种模型的性能对比如下：

| Models    |   precision   |   recall  |   f1-score    |   ROC score|
|-----------|---------------|-----------|---------------|------------|
|  sgd-clf  |   0.66994     |   0.66019 |   0.66504     |   0.77863  |
|RandomForest|  0.71710     |   0.66006 |   0.68740     |   0.81713  |
|   SVM     |   0.73468     |   0.70454 |   0.71930     |   0.82149  |

可能是心电R波提取分段或者是模型较为简单的原因，这里测试的准确度远远达不到参照的那篇论文。。。准备尝试神经网络识别分类
